...
.hero-overlay {
  ...
  background:
    linear-gradient(
      90deg,
      rgba(20, 27, 23, 0.08) 0%,
      rgba(20, 27, 23, 0) 45%,
      rgba(20, 27, 23, 0.04) 100%
    );
  pointer-events: none;
}
...
/* Prevent browser broken-image text/filename from becoming visible. */
